...
func (s *ExportServices) ExportSupplierCategoriesToExcel(branchID string) ([]byte, error) {
	...
	if tableErr != nil {
		log.Printf("[ExportSupplierCategoriesToExcel] AddTable warning: %v", tableErr)
	}
