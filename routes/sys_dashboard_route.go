...
func SysDashboardRoute(app *fiber.App) {
	...
	app.Get("/api/dashboard/top-selling-products", middlewares.JWTMiddleware, middlewares.RoleMiddleware("administrator", "operator", "cashier", "finance", "superadmin"), controllers.GetTopSellingProducts)
	app.Get("/api/dashboard/least-selling-products", middlewares.JWTMiddleware, middlewares.RoleMiddleware("administrator", "operator", "cashier", "finance", "superadmin"), controllers.GetLeastSellingProducts)
